...
Module Week9LoopsAndArrays
    ...
    Sub Main()
        ...
        Do While keepPlaying
            ...
            ' This is useful becuase the Menu options start with 1 instead of 0
            ...
            ' This allows the user to keep selecting options until 0 is selected
    ...
    Sub ShowHistory(history As List(Of String))
        ...
        Else
            ...
            ' This displays previous history
